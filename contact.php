...
if (isset($_POST['nom'])&& isset($_POST['email'])) {
        ...
        $sql=$db->query("INSERT INTO message SET nom=$nom, email=$email, coment=$msg, tel=$tel");
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <li>
                    <a class="page-scroll" href="repare.php">Troc</a>
                </li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title text-center">
                        ...
                        <p class="white-text">Nous sommes en attente de vos besoins</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <form action="#" id="contactForm" method="POST">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <textarea class="form-control" placeholder="Message *" name="msg" id="msg" required data-validation-required-message="Please enter a message."></textarea>
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
