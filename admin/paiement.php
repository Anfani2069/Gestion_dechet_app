...
$select= $db->query('SELECT * FROM paiement ORDER BY nom ASC');
$paies=$select->fetchAll();


if (isset($_POST['nom']) && isset($_POST['ile'])) {
    
        $nom = $db-> quote($_POST['nom']);
        $ile = $db-> quote($_POST['ile']);
        $tel= $db-> quote($_POST['tel']);
        $carti= $db-> quote($_POST['carti']);
        $ville = $db-> quote($_POST['vile']);
        $date= $db-> quote($_POST['date']);
        $som = $db-> quote($_POST['som']);
        ...
        $sql=$db->query("INSERT INTO paiement SET nom=$nom, prenom=$prenom, ville=$ville ,ile=$ile, date_pai=$date, carti=$carti, tel=$tel, som=$som");
...
<head>
    ...
    <title>Gestions des déchets</title>
...
<section>
    ...
    <section class="content">
        <div class="container-fluid">
                                 ...
                                 <div class="row">
                                     ...
                                     <div class="col-md-4">
                                        <div class="input-group">
                                            <span class="input-group-addon">Iles :</span>
                                            <div class="form-line">
                                     ...
                                     <div class="col-md-4">
                                        <div class="input-group">
                                            <span class="input-group-addon">Quartiers :</span>
                                            <div class="form-line">
                                               <select  name="carti" class="form-control show-tick">
                                      ...
                                      <div class="col-md-4">
                                            ...
                                            <span class="input-group-addon">Ville :</span>
                                                <div class="form-line">
                                                    <input name="vile" type="text" class="form-control" placeholder="">
                                                </div>
                                            </div>
                                      </div>
                                      <div class="col-md-3">
                                      ...
                                      <div class="col-md-3">
                                        <div class="input-group">
                                            <label class="input-group-addon">Somme</label>
                                            <div class="form-line">
                                                <input name="som" type="text" class="form-control " >
                                            </div>
                                            <span class="input-group-addon">KMF</span>
                                        </div>
                                        <div class="col-md">
                                        <div class="input-group">
            ...
            <!-- #END# GESTION DES PAIEMENTS  FORMULAIRE -->
